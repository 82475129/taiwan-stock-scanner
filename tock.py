...
if display_data:
    ...
    edited_df = st.data_editor(
        ...
        column_config={
            ...
            "Yahoo": st.column_config.LinkColumn("Yahoo 連結", display_text="🔍"),
        },
    ...
    for r in display_data:
        ...
        with st.expander(f"{'❤️' if is_fav else '🔍'} {sid} {r['名稱']} | K線詳情", expanded=True):
