...
if trigger_scan:
    ...
    if results:
        ...
        for r in results:
            ...
            with ce: exp = st.expander(f"🔍 {r['sid']} {r['name']} | {' + '.join(r['hits'])}", expanded=is_searching)
            with cf:
            ...
            with exp:
                ...
                fig.update_layout(height=400, xaxis_rangeslider_visible=False, margin=dict(l=5, r=5, t=5, b=5)); st.plotly_chart(fig, use_container_width=True)
